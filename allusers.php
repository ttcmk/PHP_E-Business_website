...
<nav class="navbar navbar-inverse" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="#">E-Business Website</a>
        </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a name="name" href="ViewOrders.php?userID=<?php echo $userID?>&name=<?php echo $username?>&customertype=<?php echo $customerType?>">View Past Orders</a></li>
                        </ul>
                    </li>
                </ul>
            </form>
...
for ($i = 0; $i < $data_count; $i++) {
    ...
    echo "<tr><td>$productID</td><td>$productName</td><td>$amount</td><td>$price</td><td>$kind</td>
                ...
                <td>
                <input type='number' name='quantity' min='1' max='$amount'><small>(inventory amount: $amount)</small>
                </td>
                <td>
